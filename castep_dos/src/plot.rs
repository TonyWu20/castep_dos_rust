...
pub fn plot(
    ...
    let root = SVGBackend::new(&plot_name, (1800, 900)).into_drawing_area();
    root.fill(&MANTLE)?;
    ...
    chart
        ...
        .y_label_style(("source sans pro,bold", 18).with_color(TEXT))
        .x_label_style(("source sans pro,bold", 18).with_color(TEXT))
        .draw()
        .unwrap();
